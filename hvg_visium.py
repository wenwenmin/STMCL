...
for i, mtx in enumerate(filtered_mtx):
    ...
    pathset = f"./data/preprocessed_expression_matrices/Alex/{samps[i]}"

    print(log_transformed_expression.shape)
    if not os.path.exists(pathset):
        os.makedirs(pathset)
    np.save(f"./data/preprocessed_expression_matrices/Alex/{samps[i]}/preprocessed_matrix.npy",
