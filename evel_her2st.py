...
if SAVE_EMBEDDINGS:
    for fold in range(32):
        save_embeddings(model_path=f"./model_result/her2st_15/{names[fold]}/best_{fold}.pt",
                        save_path=f"./embedding_result/her2st_result_15/embeddings_{fold}/",
...
# np.savetxt('hvg_pcc_values.txt', hvg_R)
...
# hvg_R_loaded = np.loadtxt('hvg_pcc_values.txt')
# print(type(hvg_R_loaded))
# print(hvg_R_loaded.shape)
# print(hvg_R_loaded[0])
# print(hvg_R_loaded[0].shape)
# print(np.mean(hvg_R_loaded))
